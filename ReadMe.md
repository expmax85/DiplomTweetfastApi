...
## Sentry
Также для отладки непредвиденных ошибок можно использовать Sentry. Для этого необходимо указать в в файле .env ваш DSN для созданного в Sentry проекта. Отправляются только не ожидаемые исключения.